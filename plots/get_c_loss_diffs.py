...
c_loss = "/Users/adahlberg/Documents/QLinkLayer/simulations/major_simulation/2019-01-16T11:10:28CET_CREATE_and_measure/2019-01-16T11:10:28CET_key_QLINK_WC_WC_HIGH_C_LOSS_1e-04_mix_uniform_weights_lowerWFQ_run_0.db"
...
print("F: {}".format(max_f_diff))
print("T: {}".format(max_t_diff))
print("L: {}".format(max_l_diff))
print("O: {}".format(max_o_diff))
