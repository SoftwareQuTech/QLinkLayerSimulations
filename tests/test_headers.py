...
class TestRequestHeader(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(request.min_fidelity, 0)
        self.assertEqual(request.max_time, 0)
        ...
        self.assertIs(request.create_id, None)
        self.assertIs(request.create_time, None)

        request = EGPRequest(other_ip=self.other_ip, other_port=self.other_port, num_pairs=self.num_pairs,
        ...
        self.assertEqual(request.min_fidelity, self.min_fidelity)
        self.assertEqual(request.max_time, self.max_time)
    ...
    def test_assign_create_id(self):
        ...
        self.assertEqual(create_time, self.create_time)
    ...
    def test_copy(self):
        ...
        self.assertEqual(request.min_fidelity, request_copy.min_fidelity)
        self.assertEqual(request.max_time, request_copy.max_time)
        ...
        self.assertEqual(request.create_time, request_copy.create_time)
    ...
    def test_pack_unpack(self):
        ...
        self.assertEqual(len(requestH), 24)
