...
from qlinklayer.feu import dm_fidelity, SingleClickFidelityEstimationUnit
...
class TestSingleClickFidelityEstimationUnit(unittest.TestCase):
    def test_dm_fidelity(self):
        ...
        self.assertEqual(dm_fidelity(dm00, dm00), 1)
        self.assertEqual(dm_fidelity(dm00, dm01), 0)
        self.assertEqual(dm_fidelity(dm00, dm10), 0)
        self.assertEqual(dm_fidelity(dm00, dm11), 0)

        self.assertEqual(dm_fidelity(dm01, dm00), 0)
        self.assertEqual(dm_fidelity(dm01, dm01), 1)
        self.assertEqual(dm_fidelity(dm01, dm10), 0)
        self.assertEqual(dm_fidelity(dm01, dm11), 0)

        self.assertEqual(dm_fidelity(dm10, dm00), 0)
        self.assertEqual(dm_fidelity(dm10, dm01), 0)
        self.assertEqual(dm_fidelity(dm10, dm10), 1)
        self.assertEqual(dm_fidelity(dm10, dm11), 0)

        self.assertEqual(dm_fidelity(dm11, dm00), 0)
        self.assertEqual(dm_fidelity(dm11, dm01), 0)
        self.assertEqual(dm_fidelity(dm11, dm10), 0)
        self.assertEqual(dm_fidelity(dm11, dm11), 1)
    ...
    def test_fidelity_estimation(self):
        ...
        estimated_fidelity = dm_fidelity(estimated_state, ideal_state)
        ...
        estimated_fidelity = dm_fidelity(ideal_state, estimated_state)
        self.assertEqual(estimated_fidelity, 0.5)
